    ...
    <div >
        ...
        <div class="h-fit mt-20">
            ...
            <div class="flex flex-col gap-20">
                <card1 media="" title="AI creates summary, you save time" description="Just paste the URL and get a summary in seconds. No manual work - just quick and effective summaries for your learning and documenting."></card1>

                <card1 media="" title="Save and Organize Your Summaries" description="Keep all your summaries in one place. Search through your history and access them anytime. Build your personal knowledge library effortlessly."></card1>

                <card1 media="" title="Multi-Language Support" description="Summarize content in any language and get results in your preferred language. Break language barriers and access global content effortlessly."></card1>

                <card1 media="" title="Export and Share Anywhere" description="Download your summaries as PDF, copy to clipboard, or share directly via link. Take your summaries wherever you need them - docs, notes, emails, or presentations."></card1>
            </div>
        </div>
